...
original_file = r"/hppfs/work/pn39mu/go69tef3/eqasim_bavaria/bavaria/data/simulation_input/simulation_per_city/fuerth/fuerth_network.xml.gz"

# Load your modified network file  
modified_file = r"/hppfs/work/pn39mu/go69tef3/eqasim_bavaria/bavaria/data/subgraph/network_files/fuerth/fuerth_seed_3_hex500_mean4_std8/networks/network_seed3_fuerth_primary_n1_s303.xml.gz"
# Use your existing matsim_network_input_to_gdf function or similar
original_network, _, _, _, _ = matsim_network_input_to_gdf(original_file)
modified_network, _, _, _, _ = matsim_network_input_to_gdf(modified_file)

# Or parse XML directly to get link attributes: id, from, to, capacity
