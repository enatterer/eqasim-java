...
**Usage**: This file is read by `generating_commands.py` to create city-specific command parameters for the `--subgraph_counts` argument in subgraph creation.
...
per city at https://www.overleaf.com/project/67f386f04fb670464d9bdd66
